    ...
    <div class="cbx-backend_container_header">
        <div class="cbx-backend_wrapper cbx-backend_header_wrapper">
            <div class="menu-heading">
                <img title="CBX Poll - Helps & Updates"   src="<?php echo esc_url(CBXPOLL_ROOT_URL) . 'assets/images/icon_log.svg';
            ...
            <a href="<?php echo esc_url(admin_url('edit.php?post_type=cbxpoll&page=cbxpoll-settings')); ?>" class="button button-primary
