...
?>
<?php
$plugin_url = PollHelper::url_utmy( 'https://codeboxr.com/product/cbx-poll-for-wordpress/' );
$doc_url    = PollHelper::url_utmy( 'https://codeboxr.com/doc/cbxpoll-doc/' );
?>
<div class="wrap cbx-chota cbxpoll-page-wrapper cbxpoll-support-wrapper" id="cbxpoll-support">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h2></h2>
        ...
        <div class="row">
            ...
            <div class="col-6">
                    ...
                    <div class="content">
                        <div class="cbx-backend-settings-row">
                            <a href="<?php echo esc_url( $plugin_url ); ?>" target="_blank">
                                ...
                                <?php esc_html_e( 'CBX Poll Plugin Details', 'cbxpoll' ); ?> </a>
                        </div>
                        <div class="cbx-backend-settings-row">
                            <a href="<?php echo esc_url( $doc_url ); ?>" target="_blank">
                                ...
                                <?php esc_html_e( 'Documentation & User Guide', 'cbxpoll' ); ?> </a>
                        </div>
                        <div class="cbx-backend-settings-row">
                            <a href="https://wordpress.org/support/plugin/cbxpoll/reviews/#new-post" target="_blank">
                                <svg viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="cbx-backend-card dashboard-wp-plugin">
                    ...
                    <div class="content">
                        <?php
                        $items = PollHelper::codeboxr_news_feed();
