...
Polls can be created as text, photo, video, audio, html. Both Logged in and guest users can vote for poll. Logged in users can submit poll from frontend as pro feature.
